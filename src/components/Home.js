...
const Home = () => {
    ...
    return (
        <div className="container">
            <h2 className='w-100 d-flex justify-content-center p-3'>React JS With Laravel</h2>
                <div className='row'>
                    <div className='col-md-4'>
                        ...
                        <form>
                            ...
                            <div className="mb-3 mt-3">
                                ...
                                <input type="text" className="form-control" id="position" placeholder="Enter Your Designation" name="position" onChange={e => changeUserFieldHandler(e)} />
                            </div>
